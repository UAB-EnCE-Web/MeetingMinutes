...
* David R. to develop agendas prior to future meetings
...
* General Implementation Procedures
	* E&CE Web Committee provides high-level guidance
	* Faculty Rep (Arie Nakhmani) and an assistant (Laxmi Ray) develop and implement details
	* Jan reviews changes upon implementation; Jan also receives suggestions for approval before passing to implementation.
* Preparation of agendas before meetings -> we should have them.
...
* Overall "Home" page (Develop a Demo)
	* Not much text
	* Labs near bottom
